...
event.preventDefault();
  ...
  if (password.length < 10 || !/[A-Z]/.test(password)
    ...
    Swal.fire({
      ...
      text: 'La contraseña debe tener al menos 10 caracteres, incluyendo tener al menos una letra mayúscula, una letra minúscula, un número y un carácter especial.',
      background: '#000000',
      color: '#ffffff',
      confirmButtonColor: '#0d6efd'
    });
